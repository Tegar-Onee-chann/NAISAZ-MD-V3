module.exports = {
    ...
    start: async(naisa, m, { commands, args, prefix, text, toUpper }) => {
        ...
        if (args[0]) {
            ...
            let templateButtons = [
                {index: 1, urlButton: { displayText: "Source Code", url: "https://youtube.com/c/dryanbot" }},
                {index: 2, urlButton: { displayText: "Main APIs", url: "http://zenzapis.xyz" }},
                {index: 3, quickReplyButton: {displayText: 'This is a reply, just like normal buttons!', id: 'id-like-buttons-message'}},
            ]

            let templateMessage = {
                image: { url: 'https://telegra.ph/file/a4f0403cb75feb80067ce.jpg' },
                caption: teks,
                footer: config.footer,
                templateButtons: templateButtons
            }

            naisa.sendMessage(m.from, templateMessage, { quoted: m })
        }
    },
    noLimit: true,
}
